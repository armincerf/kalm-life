...
<html lang="en">
	<head>
		...
		<script type="text/javascript" async="" src="//bunseki.juxt.pro//js"><\/script>
		<script type="text/javascript">
			var _paq = window._paq = window._paq || [];
			/* tracker methods like "setCustomDimension" should be called before "trackPageView" */
			_paq.push(["setCookieDomain", "*.kalm.life"]);
			_paq.push(["setDomains", ["*.kalm.life","*.www.kalm.life"]]);
		  ...
		  <\/script>
		  <noscript><p><img src="//bunseki.juxt.pro/m.php?siteid=5&amp;rec=1" style="border:0;" alt="" /></p></noscript>
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-46ca59d4.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-46ca59d4.js", "/./_app/chunks/vendor-afb36f77.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-953b11c3.js", "css": ["/./_app/assets/pages/__layout.svelte-288160a5.css"], "js": ["/./_app/pages/__layout.svelte-953b11c3.js", "/./_app/chunks/vendor-afb36f77.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-277c6eec.js", "css": [], "js": ["/./_app/error.svelte-277c6eec.js", "/./_app/chunks/vendor-afb36f77.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-4a4af582.js", "css": ["/./_app/assets/pages/index.svelte-dd763a63.css"], "js": ["/./_app/pages/index.svelte-4a4af582.js", "/./_app/chunks/vendor-afb36f77.js"], "styles": [] }, "src/routes/kalm-routines-privacy-policy.svelte": { "entry": "/./_app/pages/kalm-routines-privacy-policy.svelte-f6e12642.js", "css": ["/./_app/assets/pages/kalm-routines-privacy-policy.svelte-2b976b5c.css"], "js": ["/./_app/pages/kalm-routines-privacy-policy.svelte-f6e12642.js", "/./_app/chunks/vendor-afb36f77.js", "/./_app/chunks/env-a13806e5.js"], "styles": [] }, "src/routes/kalm-routines-terms.svelte": { "entry": "/./_app/pages/kalm-routines-terms.svelte-ef1c45e8.js", "css": ["/./_app/assets/pages/kalm-routines-privacy-policy.svelte-2b976b5c.css"], "js": ["/./_app/pages/kalm-routines-terms.svelte-ef1c45e8.js", "/./_app/chunks/vendor-afb36f77.js", "/./_app/chunks/env-a13806e5.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "/./_app/pages/about.svelte-939edcb7.js", "css": ["/./_app/assets/pages/kalm-routines-privacy-policy.svelte-2b976b5c.css"], "js": ["/./_app/pages/about.svelte-939edcb7.js", "/./_app/chunks/vendor-afb36f77.js", "/./_app/chunks/env-a13806e5.js"], "styles": [] }, "src/routes/todos/index.svelte": { "entry": "/./_app/pages/todos/index.svelte-2be32a2c.js", "css": ["/./_app/assets/pages/todos/index.svelte-05e41044.css"], "js": ["/./_app/pages/todos/index.svelte-2be32a2c.js", "/./_app/chunks/vendor-afb36f77.js"], "styles": [] } };
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<header class="${"svelte-1uyfahr"}"><nav class="${"svelte-1uyfahr"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-1uyfahr"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-1uyfahr"}"></path></svg>
		<ul class="${"svelte-1uyfahr"}"><li class="${["svelte-1uyfahr", $page.path === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-1uyfahr"}">Home</a></li>
			<li class="${["svelte-1uyfahr", $page.path === "/about" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/about"}" class="${"svelte-1uyfahr"}">About</a></li>
			<li class="${["svelte-1uyfahr", $page.path === "/todos" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/todos"}" class="${"svelte-1uyfahr"}">Todos</a></li></ul>
		<svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-1uyfahr"}"><path d="${"M0,0 L0,3 C0.5,3 0.5,3 1,2 L2,0 Z"}" class="${"svelte-1uyfahr"}"></path></svg></nav>

	<a href="${"https://github.com/armincerf/kalm-mobile"}" class="${"github-corner svelte-1uyfahr"}" aria-label="${"View Kalm Routines source on GitHub"}"><svg width="${"80"}" height="${"80"}" viewBox="${"0 0 250 250"}" style="${"fill:#fff; position: absolute; top: 0; border: 0; right: 0;"}" aria-hidden="${"true"}" class="${"svelte-1uyfahr"}"><path d="${"M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z"}"></path><path d="${"M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2"}" fill="${"black"}" style="${"transform-origin: 130px 106px;"}" class="${"octo-arm svelte-1uyfahr"}"></path><path d="${"M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z"}" fill="${"black"}" class="${"octo-body"}"></path></svg></a>
</header>`;
});
var css$5 = {
